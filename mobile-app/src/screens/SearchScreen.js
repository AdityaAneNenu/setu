...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 12, fontFamily: fonts.semiBold, color: colors.textLight, letterSpacing: 0.5, marginBottom: 12, marginLeft: 4 },
  ...
  resultCount: { fontSize: 13, fontFamily: fonts.medium, color: colors.textLight, marginBottom: 12 },
  ...
  resultMeta: { fontSize: 13, fontFamily: fonts.regular, color: colors.textLight, textTransform: 'capitalize' },
