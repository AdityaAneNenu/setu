...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        post_offices_data = [
            {
                "name": "Rajpur Post Office",
                "pincode": "110001",
                "district": "Delhi",
                "state": "Delhi",
                "postmaster_name": "Mr. Rajesh Kumar",
                "contact_number": "9876543210",
                "latitude": Decimal("28.6139"),
                "longitude": Decimal("77.2090"),
            },
            {
                "name": "Khandsa Post Office",
                "pincode": "122001",
                "district": "Gurugram",
                "state": "Haryana",
                "postmaster_name": "Ms. Priya Sharma",
                "contact_number": "9876543211",
                "latitude": Decimal("28.4595"),
                "longitude": Decimal("77.0266"),
            },
            {
                "name": "Badarpur Post Office",
                "pincode": "110044",
                "district": "Delhi",
                "state": "Delhi",
                "postmaster_name": "Mr. Suresh Singh",
                "contact_number": "9876543212",
                "latitude": Decimal("28.4957"),
                "longitude": Decimal("77.3086"),
            },
            {
                "name": "Bhiwandi Post Office",
                "pincode": "421302",
                "district": "Thane",
                "state": "Maharashtra",
                "postmaster_name": "Mrs. Sunita Patil",
                "contact_number": "9876543213",
                "latitude": Decimal("19.2952"),
                "longitude": Decimal("73.0634"),
            },
            {
                "name": "Ballabhgarh Post Office",
                "pincode": "121004",
                "district": "Faridabad",
                "state": "Haryana",
                "postmaster_name": "Mr. Dinesh Yadav",
                "contact_number": "9876543214",
                "latitude": Decimal("28.3406"),
                "longitude": Decimal("77.3267"),
            },
        ]
        ...
        for po_data in post_offices_data:
            po, created = PostOffice.objects.get_or_create(
                name=po_data["name"], defaults=po_data
            )
        ...
        pmajay_offices_data = [
            {
                "name": "PM-AJAY Delhi Regional Office",
                "district": "Delhi",
                "state": "Delhi",
                "officer_name": "Dr. Amit Verma",
                "contact_number": "9876540001",
                "email": "delhi@pmajay.gov.in",
            },
            {
                "name": "PM-AJAY Haryana Regional Office",
                "district": "Gurugram",
                "state": "Haryana",
                "officer_name": "Mrs. Kavita Jain",
                "contact_number": "9876540002",
                "email": "haryana@pmajay.gov.in",
            },
            {
                "name": "PM-AJAY Maharashtra Regional Office",
                "district": "Thane",
                "state": "Maharashtra",
                "officer_name": "Mr. Ravi Desai",
                "contact_number": "9876540003",
                "email": "maharashtra@pmajay.gov.in",
            },
        ]
        ...
        for office_data in pmajay_offices_data:
            ...
            if created:
                ...
                if "Delhi" in office.name:
                    office.serves_post_offices.set(
                        [po for po in post_offices if po.state == "Delhi"]
                    )
                elif "Haryana" in office.name:
                    office.serves_post_offices.set(
                        [po for po in post_offices if po.state == "Haryana"]
                    )
                elif "Maharashtra" in office.name:
                    office.serves_post_offices.set(
                        [po for po in post_offices if po.state == "Maharashtra"]
                    )
            else:
        ...
        for i, name in enumerate(worker_names):
            ...
            worker, created = Worker.objects.get_or_create(
                ...
                defaults={
                    ...
                    "current_location_lat": Decimal("28.4595")
                    + Decimal(random.uniform(-0.1, 0.1)),
                    "current_location_lng": Decimal("77.0266")
                    + Decimal(random.uniform(-0.1, 0.1)),
                },
            )
        ...
        for i, scenario in enumerate(complaint_scenarios):
            ...
            post_office = random.choice(
                [
                    po
                    for po in post_offices
                    if po.state in ["Delhi", "Haryana", "Maharashtra"]
                ]
            )
            pmajay_office = random.choice(
                [
                    office
                    for office in pmajay_offices
                    if post_office in office.serves_post_offices.all()
                ]
            )
            ...
            complaint, created = Complaint.objects.get_or_create(
                ...
                defaults={
                    **scenario,
                    ...
                    "latitude": (
                        village.gap_set.first().latitude
                        if village.gap_set.exists()
                        else Decimal("28.4595")
                    ),
                    "longitude": (
                        village.gap_set.first().longitude
                        if village.gap_set.exists()
                        else Decimal("77.0266")
                    ),
                    "geotagged_photos": [
                        f"complaint_photos/photo_{i+1}.jpg",
                        f"complaint_photos/location_{i+1}.jpg",
                    ],
                },
            )
            ...
            if created:
                self.stdout.write(
                    f"✓ Created complaint: {complaint.complaint_id} from {complaint.villager_name}"
                )
        ...
        self.stdout.write(
            "• Agent-assisted complaint recording for illiterate villagers"
        )
