...
class DeploymentVerifier:
    ...
    def check_database_connection(self):
        ...
        try:
            ...
            self.log_info(f"Database contents: {gap_count} gaps, {village_count} villages, {user_count} users")
        except Exception as e:
    ...
    def check_firebase_configuration(self):
        ...
        firebase_config_path = project_root / "mobile-app" / "src" / "config" / "firebase.js"
        ...
        if firebase_config_path.exists():
            ...
            if 'AIzaSy' in content and '__DEV__' not in content:
                self.log_error("Firebase API keys still exposed in mobile app source code")
            else:
    ...
    def run_security_tests(self):
        ...
        large_file = SimpleUploadedFile("test.wav", large_content, content_type="audio/wav")
...
def main():
    ...
    parser.add_argument('--post-deploy', action='store_true', help='Run post-deployment checks') 
